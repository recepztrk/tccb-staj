...
namespace VetLineApp.Migrations
{
    ...
    [Migration("20250821102645_RemoveBlogPosts")]
    partial class RemoveBlogPosts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VetLineApp.Models.BlogPost", b =>
                {
            ...
            modelBuilder.Entity("VetLineApp.Models.PetVaccination", b =>
                {
                    b.Property<int>("PetVaccinationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("pet_vaccination_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("PetVaccinationId"));
            ...
            modelBuilder.Entity("VetLineApp.Models.Vaccine", b =>
                {
                    b.Property<int>("VaccineId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("VetLineApp.Models.PetVaccination", b =>
                {
                    ...
                    b.HasOne("VetLineApp.Models.Vaccine", "Vaccine")
                        .WithMany("PetVaccinations")
